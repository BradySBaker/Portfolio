export default {
  ...
  fec: {
    ...
    libraries: ['Node.js', 'Express', 'PostgreSQL', 'Redis', 'NGINX', 'Jest', 'K6', 'Docker', 'EC2', 'React-Redux', 'Jest', 'EC2/S3', 'Axios', 'Babel', 'Webpack']
  },
  ledCanvas: {
    ...
    libraries: ['Arduino', 'React', 'P5ble', 'FastLED', 'React-Color']
  }
};
